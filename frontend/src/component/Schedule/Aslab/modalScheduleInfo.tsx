        ...
        <div className="modal-box">
            <div className="flex flex-col gap-2">
                ...
                <Link className="flex justify-end" to={`/schedule/check-all`}>
                  <button className="w-1/3 text-[#FFFFFF] bg-[rgb(6,6,6)] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6" type='button'>
                    Lets Go!
                  </button>
                </Link>
            </div>
