...
import { Lock, LockKeyhole, PenLine, UserRound } from "lucide-react";
...
const SignUp = () => {
  ...
  return (
    ...
    <div className="flex flex-col w-full md:w-1/2 xl:w-2/5 2xl:w-2/5 3xl:w-1/3 mx-auto p-4 md:p-6 2xl:p-8 3xl:p-10 bg-white rounded-2xl shadow-xl">
        ...
        <form className="flex flex-col" onSubmit={handlerSubmit}>
            ...
            <div className="pb-2">
                <label className="block mb-2 text-sm font-medium text-[#111827]">Fullname</label>
                <div className="relative text-gray-400">
                    <span className="absolute inset-y-0 left-0 flex items-center p-1 pl-3">
                        <PenLine/>
                    </span> 
            ...
            <div className="pb-2">
                <label className="block mb-2 text-sm font-medium text-[#111827]">Confirm Password</label>
                <div className="relative text-gray-400">
                    <span className="absolute inset-y-0 left-0 flex items-center p-1 pl-3">
                         <LockKeyhole />
                    </span> 
