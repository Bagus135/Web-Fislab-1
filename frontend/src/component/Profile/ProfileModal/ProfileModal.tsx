        ...
        <div className="flex flex-col justify-centers w-full sm:px-12 bg-transparent">
          ...
          <div className="space-y-4 text-center">
            ...
            <div className="flex flex-row gap-10 justify-center space-x-4 align-center ">
              <a rel="noopener noreferrer " href={!profile.contact? '#': `https://wa.me/${profile.contact}`} aria-label="GitHub" className="size-10 rounded-md hover:dark:text-violet-600 dark:text-[#ffa31a]">
                <MessageCirclePlus className="size-10"/>
              </a>
              <a rel="noopener noreferrer" href={ !profile.ig ? "#" : profile.ig} aria-label="Dribble" className=" size-10 rounded-md dark:text-[#ffa31a] hover:dark:text-violet-600">
                <Instagram className="size-10"/>
              </a>
              <a rel="noopener noreferrer" href={ !profile.github ? "#" : profile.github} aria-label="Twitter" className=" size-10 rounded-md dark:text-[#ffa31a] hover:dark:text-violet-600">
