...
function Menu ({path, name} : {path : string, name : string}){
  return(
    <li>
    <Link to={path} className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-700 hover:text-black">
