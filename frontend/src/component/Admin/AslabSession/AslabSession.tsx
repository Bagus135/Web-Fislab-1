...
const AslabSession = () => {
  ...
  const SessionAslabMap = SessionAslab.map((val, idx)=>{
      return (
        <div className="rounded-md w-full shadow-[1px_2px_2px_2px_rgba(0,0,0,0,1)] shadow-gray-300  flex flex-row items-center border border-black gap-1 p-2 text-center" key={idx}>
  ...
  <div className="">
  <h1 className="font-bold text-2xl text-center mt-5"> Aslab Session</h1>
      ...
      <div className="pb-2 w-full">
            ...
            <div className="relative w-full">
                <select onChange={hanldleSelectAslab} className="pl-2 mb-2 bg-gray-50 text-gray-600 border focus:border-transparent border-gray-300 sm:text-sm rounded-lg ring ring-transparent focus:ring-1 focus:outline-none focus:ring-gray-400 block w-full p-2.5 rounded-l-lg py-3">
      ...
      <div className="pb-2 w-full">
            <label className="pl-2 block mb-2 text-sm font-medium text-[#111827]">Kelompok</label>
            <div className="relative w-full">
                <select onChange={(e)=>setValue({...value, nomorKel : Number(e.target.value)})} className="pl-2 mb-2 bg-gray-50 text-gray-600 border focus:border-transparent border-gray-300 sm:text-sm rounded-lg ring ring-transparent focus:ring-1 focus:outline-none focus:ring-gray-400 block w-full p-2.5 rounded-l-lg py-3">
                <option value={undefined}>-----</option>
      ...
      <div className="pb-2 w-full">
            <label className="pl-2 block mb-2 text-sm font-medium text-[#111827]">Week</label>
            <div className="relative w-full">
                <select onChange={(e)=> setValue({...value, week : Number(e.target.value)})} className="pl-2 mb-2 bg-gray-50 text-gray-600 border focus:border-transparent border-gray-300 sm:text-sm rounded-lg ring ring-transparent focus:ring-1 focus:outline-none focus:ring-gray-400 block w-full p-2.5 rounded-l-lg py-3">
                <option value={undefined}>-----</option>
      ...
      <button type="submit"
                    className={`mt-5 text-[#FFFFFF] bg-[rgb(6,6,6)] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-full mb-6 hover:bg-gray-800 ${loadingAdd? "btn btn-disabled" : ''}`}
                    disabled = {loadingAdd}> 
    ...
    <div className="flex flex-col justify-stretch items-center gap-3 p-2">
            <div className="flex flex-row justify-around bg-black border-2  text-white w-full h-10 items-center font-bold text-center text-sm md:text-base">
