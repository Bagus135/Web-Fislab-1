...
const RedirectedPage = ({url} : {url : string}) => {
    return (
        <div className = "flex flex-col justify-center items-center">
            <div className="bg-white w-full border-t-4 border-r-4 border-blue-900 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
                <div className="flex p-2">
                    <div className="px-2">
                        <Info />
                    </div>
                    <div className="w-full">
                        <p className="font-bold text-xl border-b-2 text-blue-900 border-blue-900 w-full ">Redirected</p>
